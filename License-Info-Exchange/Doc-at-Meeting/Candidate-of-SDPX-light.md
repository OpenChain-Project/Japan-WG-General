...
| SPDX section no. | License Info. | Info. name in Japanese  | SPDX Light  | Rationale      |
|:------------|:-------------|:------------------|:------------------|:------------------|
...
|6.1	|License Identifier	|	| Yes	|To specify licenses which are not on the SPDX license list / To specify dual license|
|6.2	|Extracted Text	|	| Yes	|To specify licenses which are not on the SPDX license list / To specify dual license|
|6.3	|License Name	|	| Yes	|To specify licenses which are not on the SPDX license list / To specify dual license|
|6.4	|License Cross Reference	|	|	||
|6.5	|License Comment	|	| Yes	|To specify licenses which are not on the SPDX license list / To specify dual license|
